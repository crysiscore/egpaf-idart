...
ConexaoJDBC conn=new ConexaoJDBC();
	...
	private void cmdDispenseDrugsSelected(boolean dispenseNow) throws Exception {
		...
		if (!rdBtnNoAppointmentDate.getSelection() && !rdBtnYesAppointmentDate.getSelection()) { //$NON-NLS-1$
			...
			showMessage(MessageDialog.ERROR, "Seleccione se o paciente levou ou n�o cotrimoxazol",
					"Seleccione se o paciente levou ou n�o cotrimoxazol.");
...
if (!rdBtnPrintSummaryLabelNo.getSelection() && !rdBtnPrintSummaryLabelYes.getSelection()) { //$NON-NLS-1$
			...
			showMessage(MessageDialog.ERROR, "Seleccione se o paciente levou ou n�o isoniazida",
					"Seleccione se o paciente levou ou n�o isoniazida.");
	...
	return false;
		...
		if (btnNextAppDate.getDate() != null
			...
			showMessage(MessageDialog.ERROR,
					...
					"A data do pr�ximo levantamento n�o pode ser a mesma com a data de dispensa.");
			return false;
		} 
		if (PackageManager
