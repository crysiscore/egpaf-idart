...
public class Sync extends GenericFormGui  {
	...
	protected void createCompHeader() {
		String headerTxt = "Sincroniza��o das bases de dados iDART e SESP (Levantamentos de Medicamentos)";
