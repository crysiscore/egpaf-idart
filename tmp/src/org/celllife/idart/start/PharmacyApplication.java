...
DOMConfigurator.configure("log4j.xml");
		try {
			...
			//Correccoes t_tarv e t_paciente
			odbc.correccaoT_tarv_e_T_paciente();
	...
	private static void launch(String[] args) {
		...
		try {
			...
			//Sincronizacao de dispensas
			
			//delete all dispenses on sesp where date dispense is iqual to next appointment date and delete all duplicate dispenses on sesp
			//odbc.clean_delete();
			//delete dispensas repetidas e deixa somente uma
			//odbc.clean_delete_mais_de_uma_despensa();
			//update dispensas dispensa=dataproxima
			jdbc.updateDispensas();
			
			
//			    Vector<SyncLinha> synclinha=jdbc.sync_table_dispense();
//				   log.info("******************** Nids for sync dispenses ************************ ");
//			    		    
//				 
//			   for(int i=0; i<synclinha.size() ; i++)
//			   {
//				   odbc.syncdata_dispense(synclinha.get(i));
//	System.out.println("++Data lev "+  synclinha.get(i).getUltimo_lev() +"++Data proxima "+ synclinha.get(i).getDataproxima() +" Ultimo lev. sesp"+synclinha.get(i).getUltimo_sesp());
//				   log.info(synclinha.get(i).getNid());
//			   }
...
//			  Vector<SyncLinhaPatients> synclinhaPatients=jdbc.sync_table_patients();
//			    
//			 
//			    
//			   for(int i=0; i<synclinha.size() ; i++)
//			 {
//				   jdbc.syncdata_patients(synclinhaPatients.get(i));
//			  	 
//		 	 
//			  }
...
//			   
			...
			log.info("importacao de contactos..");
			jdbc.importaContactos();
			   
			log.info("formata a data proxima idart..");
			jdbc.dataProximoLevantamentoFormat();
			
			
			log.info("importacao de enderecos..");
			jdbc.importaEnderecos(); 
			
			log.info("importacao de confidentes..");
			jdbc.importaConfidentes(); 
