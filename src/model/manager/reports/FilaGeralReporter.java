...
public class FilaGeralReporter extends AbstractJasperReport {
	...
	public FilaGeralReporter(Shell parent, Date theStartDate,
			Date theEndDate) {
		super(parent);
	...
	protected Map<String, Object> getParameterMap() throws ReportException {
		...
		map.put("dataInicio",  theStartDate);
	...
	protected String getReportFileName() {
		return "patientHistoryFILAGERAL";
	}
