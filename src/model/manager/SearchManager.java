...
public class SearchManager {
    ...
    public static List<Object[]> loadRegimens(Session sess, Search search)
     ...
     /*
      * 
      * Devolve um regimes terapeutico
    ...
    public static List<? extends Object> loadRegimes(Session sess,
        ...
        String itemText[];
        search.getTableColumn1().setText("ID Regime:");
        search.getTableColumn1().addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent event) {
                cmdColOneSelected();
        ...
        search.getTableColumn2().setText("Esquema Regime:");
        search.getTableColumn2().addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent event) {
                cmdColTwoSelected();
        ...
        search.getShell().setText("Seleccione o Regime...");

        regimens = AdministrationManager.getRegimeTerapeuticos(sess);

        //IF commented , maybe can throw an exception
